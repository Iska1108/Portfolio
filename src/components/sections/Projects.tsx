      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((proj) => (
            <div
              key={proj.title}
              className="glass-card rounded-2xl overflow-hidden group hover:border-brand-accent/50 transition-colors"
            >
              <div className="h-48 bg-gradient-to-br from-slate-800 to-slate-900 relative overflow-hidden flex items-center justify-center">
                ...
                <i
                  className={`fas ${proj.icon} text-6xl text-slate-700 group-hover:text-brand-accent/50 transition-colors transform group-hover:scale-110 duration-500`}
                />
              </div>
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <a
                    href={proj.href ?? "#"}
                    className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-brand-accent hover:text-brand-dark transition-colors"
